...
<body>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div id="floorplan" style="border: 2px solid black">
                                <img src="../img/floor1.png" width="707" height="500">
                            </div>
                        </div>
                        <!-- /.panel-body -->
                    </div>
	...
	$(document).ready(function(){
		$("#floor1-img").click(function(){
            $("#floorplan").html("<img src='../img/floor1.png' width='707' height='500'>");
            $("#floor-display").html("Floor 1 <span class='caret'></span>");
        });

        $("#floor2-img").click(function(){
            $("#floorplan").html("<img src='../img/floor2.png' width='707' height='500'>");
            $("#floor-display").html("Floor 2 <span class='caret'></span>");
		});

        $("#floor3-img").click(function(){
            $("#floorplan").html("<img src='../img/floor3.png' width='707' height='500'>");
